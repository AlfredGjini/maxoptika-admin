...
$params3 = Input::get('dhena3');
		...
		foreach ($cmimet as $key => $cmimi) {
			...
			//var_dump($artikull2);
				...
				$update_products = DB::getInstance()->insert('cmime2',['idprodukti'=>$cmimi['KODARTIKULLI'],'cmimilek'=>$cmimi['CMIMIMETVSH'],'cmimieur'=>$cmimi['CMIMI_EUR'],'monedhalek'=>$cmimi['MONEDHAKOD'], 'monedhaeur'=>$cmimi['MONEDHAKOD_EUR']]);
